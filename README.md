...
選択したセル範囲を独立したタブに分離し、Excel に近いセル選択・編集・コピー＆ペースト操作で元のブックと同期する Office.js アドイン。

## 主な機能

- **範囲タブ** — 複数のセル範囲を同時に8タブまで管理
- **複数シート対応** — 他シートの範囲も個別タブとして保持し、セルクリック時に元シートへ移動
- **Excel風セル選択** — 単一クリックで選択、ドラッグで範囲選択、マウスを離した時点で元の Excel 範囲も選択
- **CellFocus内編集** — ダブルクリック / Enter / F2 でセルを編集し、元の Excel セルへ同期
- **コピー＆ペースト** — 選択範囲を TSV としてコピーし、貼り付けた値を元の Excel 範囲へ反映
